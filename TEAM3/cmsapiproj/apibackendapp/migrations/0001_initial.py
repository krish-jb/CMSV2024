...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apibackendapp.medicinecategory'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apibackendapp.labtestcategory'),
        ),
        migrations.CreateModel(
            name='Doctor',
            fields=[
                ...
                ('IsActive', models.BooleanField(default=True)),
                ('SpecializationId', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apibackendapp.specialization')),
                ('StaffId', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='apibackendapp.staff')),
            ],
        ),
        migrations.CreateModel(
            name='Consultation',
